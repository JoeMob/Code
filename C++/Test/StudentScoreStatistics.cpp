...
class studentMessage
{
  ...
  public:
    ...
    student *Find(const char *x); // 查找学生
    void Query();                 // 查询
...
void studentMessage::print()
{
    ...
    cout << "---------------------------------成绩列表------------------------------" << endl;
    printf("序号  姓名      学号      成绩1   成绩2   成绩3   成绩4   成绩5  总成绩\n");
    int no = 1;
    student *ptr = first;
    while (ptr != last)
    {
...
{
    int x;
    printf("输入你想按照哪门课的成绩来排序?((1-5)总成绩输入6):");
    cin >> x;
    x--;
