...
public class JDPhones implements PageProcessor {
    ...
    private Site site = Site.me().setRetryTimes(3).setSleepTime(1024).setUserAgent("Mozilla/5.0 (Macintosh; Intel Mac OS X 10_15_3) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/13.0.5 Safari/605.1.15");
